...
3. **迭代节奏与 envs 分档**：跟官方的分档用法走——**配方探索期 1024 envs × 2000 迭代**快速试（官方 desk-climb 续训就是 1024；trick 类任务先 500-1000 迭代看曲线再加）；**配方定稿出正式策略才用官方默认 4096 envs × 4000 迭代**；评估 64-512 envs。不一律 4096（那是官方为步态/爬梯等硬任务调的主训默认值）。
